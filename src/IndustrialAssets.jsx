...
/**
 * Hook to access all industrial asset meshes
 */
...
function createMeshComponent(meshName) {
    return function MeshComponent({ position = [0, 0, 0], rotation = [0, 0, 0], scale = 1, ...props }) {
        ...
        if (!mesh) {
            console.warn(`Mesh "${meshName}" not found in Industrial GLB`);
            return null;
        }
...
// ============================================
export function IndustrialMesh({ name, position = [0, 0, 0], rotation = [0, 0, 0], scale = 1, ...props }) {
    const { nodes } = useGLTF('/Industrial_exterior_v2.glb');
...
// ============================================
// UTILITY: List all available mesh names
// ============================================
export const MESH_NAMES = [
    ...
    'Building_11', 'Building_12', 'Building_13', 'Cooling_tower',
    // Props
    'Barrel_1', 'Barrel_2', 'Barrel_3', 'Box_wide_wood', 'Box_wood',
    'Cargo_1_close', 'Cargo_1_open', 'Cargo_2_empty', 'Cargo_2_full',
    'Liquid_reservoir_1', 'Liquid_reservoir_2', 'Bags_1', 'Bags_2',
    'Generator', 'Metal_cabinet_1', 'Metal_cabinet_2', 'Palet_single', 'Palet_stack', 'Roadblock',
    // Bridges
    ...
    // Ventilation
    'Ventilation_1', 'Ventilation_2', 'Ventilation_2_blades', 'Ventilation_3', 'Ventilation_3_blades',
    // Ground
    'Alphalt_Floor', 'Concrete_stairs', 'Concrete_miniwall_long', 'Concrete_miniwall_short',
    'Road_curved', 'Road_long', 'Road_short', 'Road_turn_1', 'Road_turn_2', 'Road_turn_3',
    // Walls/Fences
    'Wall', 'Wall_column', 'Wall_corner_1', 'Wall_corner_2', 'Wall_corner_3',
