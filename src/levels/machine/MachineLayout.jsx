...
import { MachineMesh } from './MachineAssets';

/**
 * The Machine Level Layout
 * 
 * Layout Design (top-down view, +Z is "north"):
 * 
 *         [Portal to The Pastoral - North]
 *                   |
 *     +-------------+-------------+
 *     |                           |
 *     | [Building]   [Cooling]    |
        ...
        <group>
            ...
            <RigidBody type="fixed" colliders="cuboid">
                <group position={[-20, 0, 10]}>
                    <MachineMesh name="Building_1" />
                </group>
            </RigidBody>

            <RigidBody type="fixed" colliders="cuboid">
                <group position={[-20, 0, -15]}>
                    <MachineMesh name="Building_3" />
                </group>
            </RigidBody>
            ...
            <RigidBody type="fixed" colliders="cuboid">
                <group position={[20, 0, 10]}>
                    <MachineMesh name="Cooling_tower" />
                </group>
            </RigidBody>

            <RigidBody type="fixed" colliders="cuboid">
                <group position={[20, 0, -10]}>
                    <MachineMesh name="Liquid_reservoir_1" />
                </group>
            </RigidBody>

            <RigidBody type="fixed" colliders="cuboid">
                <group position={[15, 0, -18]}>
                    <MachineMesh name="Liquid_reservoir_2" />
                </group>
            </RigidBody>
            ...
            <RigidBody type="fixed" colliders="cuboid">
                <group position={[-12, 0, -5]}>
                    <MachineMesh name="Cargo_2_full" />
                </group>
            </RigidBody>

            <RigidBody type="fixed" colliders="cuboid">
                <group position={[-8, 0, 0]}>
                    <MachineMesh name="Cargo_1_close" />
                </group>
            </RigidBody>
            ...
            <RigidBody type="fixed" colliders="cuboid">
                <group position={[-10, 0, 3]}>
                    <MachineMesh name="Barrel_1" />
                </group>
            </RigidBody>

            <RigidBody type="fixed" colliders="cuboid">
                <group position={[-9, 0, 4]}>
                    <MachineMesh name="Barrel_2" />
                </group>
            </RigidBody>
            ...
            <group position={[18, 3, 0]}>
                <MachineMesh name="Pipes_horizontal_long" />
            </group>
            <group position={[22, 0, -5]}>
                <MachineMesh name="Pipes_vertical_long" />
            </group>
            <group position={[22, 0, 5]}>
                <MachineMesh name="Pipes_support" />
            </group>
